...
public class ClientInterface extends javax.swing.JFrame {
 ...
 /*---->>>*/    sys.EscreveLogConsole("ClienteInterface - Metodo Disconnected[DES]",  "[" + this.message.getName()+ "]" + "Texto Descriptografado : " + classeDES.CriptoDESPaddingECBDecrypter(txtbyte, chaveDES));
/*---->>>*/    sys.EscreveLogConsole("ClienteInterface - Metodo Disconnected[DES]", "[" + this.message.getName() + "]" + "***FIM***");
/*---->>>*/ } else if (this.message.getTpCrypt() == 3) {try {
/*---->>>*/     //DES CBC
        ...
        */
        if (txtAreaSend.getText().isEmpty() || txtAreaSend.getText().equals(null)) {
            ...
            */
            ...
            if(this.message.getTpCrypt() == 2){
                //DES ECB
                sys.EscreveLogConsole("[btnEnviarActionPerformed]","[ChaveDES] : " + Base64.getEncoder().encodeToString(chaveDES.getEncoded()));
/*---->>>*/     sys.EscreveLogConsole("[btnEnviarActionPerformed]", "TextoDescriptografado : " + classeDES.CriptoDESPaddingECBDecrypter(txtbyte, chaveDES));
