...
public class ClientInterface extends javax.swing.JFrame {
    ...
    private byte[] criptografarDES(int i, String txt) {
        ...
        if (i == 2) {
            ...
            aux = classeDES.DESPaddingECB(txt, chaveDES);
        } else if (i == 3) {
            ...
            */
            ...
            if(this.message.getTpCrypt() == 2){
                ...
                sys.EscreveLogConsole("[btnEnviarActionPerformed]","[ChaveDES-CBC] : " + Base64.getEncoder().encodeToString(chaveDESCBC.getEncoded()));
                 sys.EscreveLogConsole("[btnEnviarActionPerformed]", "TextoDescriptografado : " + classeDES.DESPaddingCBCDecrypter(txtbyte, chaveDESCBC));
            }
