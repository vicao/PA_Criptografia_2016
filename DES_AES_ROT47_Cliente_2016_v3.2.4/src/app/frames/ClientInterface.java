...
/*---->>>*/ resultado = classeDES.CriptoDESPaddingECBDecrypter(message.getBytetxt(), chaveDESECB);//Descriptografa a mensagem
            ...
            try {
                //AES
                resultado = aes.decrypt(txtbyte, chaveAES);
                this.txtAreaReceive.append(message.getName() + " diz : " + resultado + "\n");
            } catch (Exception ex) {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (txtAreaSend.getText().isEmpty() || txtAreaSend.getText().equals(null)) {
            ...
            if (this.message.getTpCrypt() == 0) {
                ...
                /*---->>>*/ if (this.message.getTpCrypt() == 2) {
/*---->>>*/                  //DES ECB
/*---->>>*/                  sys.EscreveLogConsole("btnEnviarActionPerformed", "[ChaveDES] : " + Base64.getEncoder().encodeToString(chaveDESECB.getEncoded()));
/*---->>>*/                  sys.EscreveLogConsole("btnEnviarActionPerformed", "TextoDescriptografado : " + classeDES.CriptoDESPaddingECBDecrypter(txtbyte, chaveDESECB));
/*---->>>*/                } else if (this.message.getTpCrypt() == 3) {
/*---->>>*/                     try {
/*---->>>*/                         //DES CBC
/*---->>>*/                         sys.EscreveLogConsole("btnEnviarActionPerformed", "[ChaveDES-CBC] : " + Base64.getEncoder().encodeToString(chaveDESCBC.getEncoded()));
/*---->>>*/                         sys.EscreveLogConsole("btnEnviarActionPerformed", "TextoDescriptografado : " + classeDES.decryptCBC(txtbyte, "password"));
/*---->>>*/                    } catch (Exception ex) {
/*---->>>*/                         Logger.getLogger(ClientInterface.class.getName()).log(Level.SEVERE, null, ex);
/*---->>>*/                    }
/*---->>>*/                }
...
/*---->>>*/
                ...
                try {
                //AES
                sys.EscreveLogConsole("btnEnviarActionPerformed", "[AES - 4]");

                txtbyte = criptografiaAES(text);
                sys.EscreveLogConsole("btnEnviarActionPerformed","TextoDescriptografado : " + aes.decrypt(txtbyte, chaveAES));
                } catch (Exception ex) {
                    Logger.getLogger(ClientInterface.class.getName()).log(Level.SEVERE, null, ex);
                }
               ...
               try {
                //AES
                sys.EscreveLogConsole("btnEnviarActionPerformed", "[AES - 5]");
                ...
                sys.EscreveLogConsole("btnEnviarActionPerformed", "[RSA]");
            }
            /*            
    ...
    private void btnConnectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectarActionPerformed
        ...
        if (aux) {
            ...
            /* Validação de Criptografia Antiga.
    ...
    private void ValidaCriptoEnviaMsg(String textoDigitado) {
        ...
        if (this.message.getTpCrypt() == 0) {
            ...
            //DES ECB
            sys.EscreveLogConsole("[btnEnviarActionPerformed]", "[" + this.message.getName() + "]" + "[ChaveDES-ECB] : " + Base64.getEncoder().encodeToString(chaveDESECB.getEncoded()));
            sys.EscreveLogConsole("[btnEnviarActionPerformed]", "[" + this.message.getName() + "]" + "[DES-ECB]TextoDescriptografado : " + classeDES.CriptoDESPaddingECBDecrypter(txtbyte, chaveDESECB));
